...
export const VideosPanel = memo(({ creatorEmail, userType, editorEmail }: {
    ...
    return <div className="p-6">
        ...
        <div className="flex flex-wrap items-center gap-3 mb-6">
            ...
            {userType === "editor" ? 
                <ChatPanel fromUser={editorEmail} toUser={creatorEmail} requestEditor={false} /> : 
                editorEmail !== "" ? 
                    <ChatPanel fromUser={creatorEmail} toUser={editorEmail} requestEditor={false} /> : 
                    <></>
            }
        </div>
        ...
        {userType === "creator" && (
            <div className="mt-8">
                <FindEditor creatorEmail={creatorEmail} />
            </div>
        )}
    </div>
})